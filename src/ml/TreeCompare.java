...
public class TreeCompare {
	...
	// "/space/raxml/VINCENT/RAxML_bipartitions.855.BEST.WITH" );
	File treeFile = new File(
		"/home/sim/mnt_ibc/tmp/RAxML_originalLabelledTree.855_0000");
	...
	for (LN[] b : branches) {
	    ...
	    System.out.printf("%d %d %s %s\n", b[0].data.serial,
		    b[1].data.serial, b[0].backLabel, b[1].backLabel);
	}
    }
    ...
    public static void getAllBranchesRec(LN n, boolean back,
	    ArrayList<LN[]> branches) {
	if (back) {
	    if (n.back != null) {
		LN[] b = { n, n.back };
		branches.add(b);
