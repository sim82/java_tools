...
public class SimulateMoves {
	...
	public static void main(String[] args) {
		...
		//File f = new File( "/space/raxml/VINCENT/RAxML_bipartitions.150.BEST.WITH" );
		...
		Visitor writer = new Visitor() {
			...
			public void visit(LN n) {
				String filename = "/tmp/lsr_" + n.next.back.data.serial + "-" + n.next.next.back.data.serial;
		...
		System.out.printf( "%s %s %s %s\n", nbr[0].next.back, nbr[0].next.next.back, nbr[1].next.back, nbr[1].next.next.back );
