...
//			}
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		EvoSimFossil esf = new EvoSimFossil( treeGood, fossilSeqGood, BRANCH_SCALE, bw );
		if( bw != null ) {
			bw.close();
		}
		
		EvoSimFossil esf_rand = new EvoSimFossil( treeBad, fossilSeqBad, BRANCH_SCALE );
	...
	private static void drawBranchLengths(LN tree1, LN tree2) {
		...
		for( int i = 0; i < br1.length; i++ ) {
			...
			//System.out.printf( "dd: %f %f\n", br2[i][0].backLen, br2[i][1].backLen );
		}
