...
public class ClassifierTwoCladesBSWeightRightWrong {
    ...
    //
    //
    // if( (nl1.contains(res.branch) && nl1.contains(rb)) ||
    // (nl2.contains(res.branch) && nl2.contains(rb))) {
    // or.wghr += res.support;
    // } else if((nl1.contains(res.branch) && nl2.contains(rb)) ||
    // (nl2.contains(res.branch) && nl1.contains(rb))){
    // or.wghw += res.support;
    // } else {
    ...
    //
    //
    // ml.ClassifierTwoCladesBSWeightRightWrong.Res[] orl =
    // orm.values().toArray(new Res[orm.size()]);
